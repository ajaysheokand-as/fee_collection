	...
	<head>
		...
		<script type="text/javascript">
			...
			function submitForm() {
				...
				hiddenAmt.value = parseInt(amt * 100);
			...
			<form action="Payment.php" method="post">
				...
				<table width="650px;" class="customtable-all card">
					...
					<tr>
						...
						<td width="50%" align="center" valign="middle"><input type="text" name="amount" id="amount" value="100" placeholder="In Rupess" /> </td>
					</tr>

					<tr>
						<td width="50%" align="right" valign="middle">Buyer Email</td>
						<td width="50%" align="center" valign="middle"><input type="text" name="buyerEmail" value="21jiabhi@gmail.com" /> </td>
					</tr>
					<!--<tr>
